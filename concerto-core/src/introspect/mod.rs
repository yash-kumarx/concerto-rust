...
//! a model's JSON AST into a handful of enums instead, [`Declaration`],
//! [`Property`] and [`Import`], each with the accessors we actually need.
//! A [`ModelFile`] then bundles up one namespace's declarations and imports.
